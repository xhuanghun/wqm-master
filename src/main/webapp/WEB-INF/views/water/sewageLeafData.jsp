		...
		<table style="width:99%;height:80px;margin-buttom:10px">
			<tr>
				<td width="18%" align="center" style="min-width:150px">
					...
					<input id="hidden_waterCode" type="hidden" name="sewageCode" value="${code }"/>
				</td>
				<td width="18%" align="center" style="min-width:150px">
    ...
    onDblClickRow:function (index,row){	   //双击行事件 
    	$("#monitorDataDetailDialog").show(); //先显示，再弹出
	   	$("#monitorDataDetailDialog").dialog({
	   		  title:'污水处理厂详细信息',
	   	      href:"${ctx}/sewage/sewageDetail?code="+row.code,
	   	      width:600,
	   	   	  height:600,
	   	      modal:false,
	   	   	  resizable:true,
 ...
 */
 $("#monitorDataDetailButton").click(function(){
	 ...
	 $("#monitorDataDetailDialog").dialog({
		  title:'污水处理厂详细信息',
	      href:"${ctx}/sewage/sewageDetail?code="+code,
   	      width:600,
   	   	  height:600,
   	      modal:false,
   	   	  resizable:true,
