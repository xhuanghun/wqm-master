...
<div id="monitorDataDetail_container" style="width:100%;height:100%;">
	...
	<div id="monitorDataDetailTabs" class="easyui-tabs" style="width:100%;height:100%;">
		...
		<table id="baseInfoTable" style="width:99%;cellspacing:0;cellpadding:0;border-collapse:collapse;" align="center"  border="0" cellspacing="0" >
			<tr>
				<td width="50%">供水网点名称:</td><td width="50%">${waterSupply.name} </td>
			</tr>
			<tr>
				<td width="50%">采样地址:</td><td width="50%">${waterSupply.monitorPoit} </td>
			</tr>
			<tr>
				<td width="50%">所在区域:</td><td width="50%">${waterSupply.area.name} </td>
			</tr>
...
$('#monitorDataTable').datagrid({
    url:"${ctx}/waterSupply/getMonitorData?code="+$('#code').val(),
    method:'get',
    pagination:false,
    columns:[[
        {field:'id',title:'序号'},
        {field:'waterSupplyName',title:'水库名称'},
    ...
    onLoadSuccess: function (rowData) {
    	mergeCellsByField('monitorDataTable', 'waterSupplyName');
    },
});
/**
 * 设置分页
 ...
 */
 $("#monitorTime").combobox({
	    url:'${ctx}/waterSupply/getMonitorTime?code='+$('#code').val(),
	    valueField:'id',
	    textField:'time',
	    method:'GET',
