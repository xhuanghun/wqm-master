	...
	<form id="monitorDataSearchConditionForm">
		<table style="width:99%;height:80px;margin-buttom:10px">
			<tr>
				...
				<td width="18%" align="center" style="min-width:150px">
					<label for="search_mediumReservoirName">监测名称</label>
    ...
    onDblClickRow:function (index,row){	   //双击行事件 
    	$("#monitorDataDetailDialog").show(); //先显示，再弹出
	   	$("#monitorDataDetailDialog").dialog({
	   		  title:row.name+'详细信息',
	   	      href:"${ctx}/mediumReservoir/mediumReservoirDetail?code="+row.code,
	   	      width:600,
	   	   	  height:600,
	   	      modal:false,
	   	   	  resizable:true,
 ...
 */
 $("#monitorDataDetailButton").click(function(){
	 ...
	 $("#monitorDataDetailDialog").dialog({
		  title:name+'详细信息',
	      href:"${ctx}/mediumReservoir/mediumReservoirDetail?code="+code,
   	      width:600,
   	   	  height:600,
   	      modal:false,
   	   	  resizable:true,
