 ...
 */
@Entity
@Table(name = "BUSI_WTR_MONITORDA_TAPWATER")
public class MonitorDataTapWater extends IdEntity {
	
	private static final long serialVersionUID = 1L;
	
	private String tapWaterName;         
	private String tapWaterCode;  	
	private String itemName;	
	private String  itemValue;	
	private String company;		//单位
	private Integer monitorType;		//监测类型，频率
	private String type;		//水样类别
	...
	public String getTapWaterName() {
		return tapWaterName;
	}

	public void setTapWaterName(String tapWaterName) {
		this.tapWaterName = tapWaterName;
	}
