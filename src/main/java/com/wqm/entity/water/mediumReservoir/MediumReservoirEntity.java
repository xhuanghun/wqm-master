 ...
 */
@Entity
@Table(name = "BUSI_WTR_MEDIUMRESERVOIR")
public class MediumReservoirEntity extends IdEntity {
	
	private static final long serialVersionUID = 1L;
	
	private String code; 		//中型水库编号	
	private String name;	 	//中型水库名称	
	private UserEntity user;	//创建人员
	private AreaEntity area;	//所属区域
	private String monitorPoit;	//采样点位
	private String content;		//采样点位
	private String iconCls;		//中型水库图标	
	...
	@ManyToMany
	@JoinTable(name = "BUSI_WTR_MEDIUMRESERVOIRMONITORITEM", joinColumns = { @JoinColumn(name ="mediumReservoirCode" ,referencedColumnName = "code")}, 
